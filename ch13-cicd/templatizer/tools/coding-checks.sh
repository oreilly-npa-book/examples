...
usage () {
  echo "Usage: $0 [OPTION]..."
  echo "Run templatizer's coding check(s)"
  echo ""
  echo "  -Y, --pylint [<basecommit>] Run pylint check on the entire templatizer module or just files changed in basecommit (e.g. HEAD~1)"
